...
export function initializeViewPort( Cesium, viewer, longitude, latitude ) {
...
export function constructTrimBox( tileset, minX, maxX, minY, maxY, minZ, maxZ, union, width, Cesium ) {
